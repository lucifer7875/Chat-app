    ...
    return (
        ...
        <div className="Home" >
            ...
            <Container>
                <div className="row"
                    style={{
                        boxShadow: " box-shadow: 0 2px 4px rgb(0 0 0 / 10%), 0 8px 16px rgb(0 0 0 / 10%)",
                        width: "1100px",
                    ...
                    <div className="col-sm-6">
                        <div className="card" style={{ width: "30rem", backgroundColor: "GrayText" }}>
                            <div className="card-body">
                                <h5 className="card-title">Personal Chat</h5>
                                <i className="bi bi-person-fill" style={{ fontSize: "100px" }} ></i> <br />
                                <button className="btn btn-primary" onClick={() => navigate("/personalChat")}>Personal Chat</button>
                            </div>
                        </div>
                    </div>
                    <div className="col-sm-6">
